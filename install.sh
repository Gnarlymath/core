...
echo 'alias oliver-ark="$HOME/core-bridgechain/packages/core/bin/run"' >> ~/.bashrc

rm -rf "$HOME/core-bridgechain"
git clone "https://github.com/Gnarlymath/core" "$HOME/core-bridgechain" || FAILED="Y"
if [ "$FAILED" == "Y" ]; then
    echo "Failed to fetch core repo with origin 'https://github.com/Gnarlymath/core'"
...
rm -rf "$HOME/.config/@oliver-ark"
rm -rf "$HOME/.config/@oliver-ark"
rm -rf "$HOME/.config/oliver-ark-core"
